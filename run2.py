...
data_tr, vocab, index_arrays, labels = load_data('data/20ng/20ng_all', 'train', 'log.txt')

data_te, _, test_index_arrays, test_labels = load_data('data/20ng/20ng_all', 'test', 'log.txt', vocab)
