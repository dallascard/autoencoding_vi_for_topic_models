...
data_tr, vocab, labels = load_data('../../projects/GNTM/data/20ng/20ng_all_2000', 'train', 'log.txt')

data_te, _, test_labels = load_data('../../projects/GNTM/data/20ng/20ng_all_2000', 'test', 'log.txt', vocab)
