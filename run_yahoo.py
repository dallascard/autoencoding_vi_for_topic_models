...
data_tr, vocab, labels = load_data('../../projects/GNTM/data/yahoo_5000', 'train', 'log.txt')

data_te, _, test_labels = load_data('../../projects/GNTM/data/yahoo_5000', 'test', 'log.txt', vocab)
...
def make_network(layer1=300,layer2=100,num_topics=250,bs=200,eta=0.002):
